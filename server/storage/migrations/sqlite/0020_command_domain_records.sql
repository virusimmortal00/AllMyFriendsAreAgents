...
CREATE TABLE command_submission_tombstones (
  room_id TEXT NOT NULL, submission_id TEXT NOT NULL, client_submission_id TEXT NOT NULL, command_name TEXT NOT NULL, compacted_at TEXT NOT NULL,
  PRIMARY KEY(room_id,submission_id), UNIQUE(room_id,client_submission_id)
);
CREATE TABLE command_attempts (
  ...
  reason TEXT, delivery_messages_json TEXT, delivery_result_json TEXT, room_epoch TEXT, roster_revision INTEGER, agent_configuration_revision INTEGER, created_at TEXT NOT NULL, updated_at TEXT NOT NULL,
...
CREATE TABLE command_pov_executions (
  ...
  current_target_agent_id TEXT, generation_id TEXT, delivery_messages_json TEXT, delivery_result_json TEXT, room_epoch TEXT, roster_revision INTEGER, agent_configuration_revision INTEGER,
...
CREATE TABLE command_poll_votes (
  room_id TEXT NOT NULL, poll_id TEXT NOT NULL, voter_id TEXT NOT NULL, mutation_id TEXT NOT NULL, option_index INTEGER NOT NULL CHECK(option_index >= 0),
  created_at TEXT NOT NULL, PRIMARY KEY(room_id, poll_id, voter_id), UNIQUE(room_id, poll_id, mutation_id),
