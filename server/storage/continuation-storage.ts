import { continuationIsNonterminal, normalizeContinuationAuditEvent, normalizeContinuationInboxEntry, normalizeContinuationPolicy, normalizeContinuationRecord, type ContinuationAuditEvent, type ContinuationInboxEntry, type ContinuationPolicy, type ContinuationRecord } from "../continuation-record.js";
...
export function normalizeJsonContinuationState(value: unknown): JsonContinuationState {
  ...
  return { schemaVersion: 1, policy: normalizeContinuationPolicy(source.policy) ?? null, jobs, inbox, events };
}
