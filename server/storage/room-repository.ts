...
export interface RoomRepository extends AssignmentRecordStore, ContinuationRecordStore, CommandRecordStore {
  ...
  addCommandDeliveryMessageOnce(attemptId: string, sequence: number, speaker: RoomMessage["speaker"], text: string, style?: ChatStyle, burst?: { burstId: string; sequence: number; kind?: RoomMessage["kind"] }, spend?: { generationId?: string; costUsd?: number }): Promise<RoomMessage>;
  addPrivateCommandResponseOnce(submissionId: string, humanId: string, text: string): Promise<RoomMessage>;
