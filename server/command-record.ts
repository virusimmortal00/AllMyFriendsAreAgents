...
export interface CommandPovExecution { readonly executionId: string; readonly roomId: string; readonly submissionId: string; readonly targetAgentIds: readonly ActiveAgentId[]; readonly processedTargetAgentIds: readonly ActiveAgentId[]; readonly currentTargetAgentId?: ActiveAgentId | null; readonly generationId?: string | null; readonly deliveryMessages?: readonly string[]; readonly deliveryResult?: CommandDeliveryResult; readonly status: "queued" | "active" | "completed" | "failed" | "cancelled"; readonly reason: string | null; readonly createdAt: string; readonly updatedAt: string }
