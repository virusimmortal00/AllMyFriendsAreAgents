...
export interface CommandAttempt { readonly attemptId: string; readonly roomId: string; readonly submissionId: string; readonly attempt: number; readonly agentId: ActiveAgentId; readonly generationId: string | null; readonly status: "queued" | "active" | "completed" | "failed" | "superseded"; readonly reason: string | null; readonly roomEpoch?: string; readonly rosterRevision?: number; readonly agentConfigurationRevision?: number; readonly createdAt: string; readonly updatedAt: string }
