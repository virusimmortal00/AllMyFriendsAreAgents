import type { InvestigationAdmission } from "./investigation-authority.js";
...
export interface InvestigationRecord {
  /** Absent on legacy records, which require fresh admission before execution. */
  readonly admission?: InvestigationAdmission;
