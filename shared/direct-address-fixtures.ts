...
export const DIRECT_ADDRESS_FIXTURES: ReadonlyArray<{
  ...
  {
    text: "Sol, argue for the fictional wooden sign. Claude, argue for the fictional metal sign.",
    expected: ["agent-sol", "agent-claude"],
  },
  {
    text: "Grok, given the fictional wooden and metal sign ideas above, describe a practical compromise.",
    expected: ["agent-grok"],
  },
  ...
  { text: "Sol, given the fictional wooden sign idea, the choice seems settled.", expected: [] },
  { text: "Sol, given the sign options; describe what you prefer.", expected: [] },
  { text: "Sol, given the sign options, I will describe a compromise.", expected: [] },
  { text: "The example says ‘Sol, argue for the wooden sign.’", expected: [] },
