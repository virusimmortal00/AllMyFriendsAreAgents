...
export function appFixtureResponse(path: string, method: string, scenario: string): FixtureResponse {
  ...
  if (method === "POST" && route === "/api/control/diagnostics/query" && scenario === "owner-diagnostics-sign-in") return unauthorized;
