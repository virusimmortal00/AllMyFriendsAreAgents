...
export const WORKSPACE_NAMES = ["Improvements", "Tasks", "Continuations", "Investigations", "Reviewed contributions", "Diagnostics", "Server Administration", "Integrations"] as const;
