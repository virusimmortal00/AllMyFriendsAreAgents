// OpenRouter glyph from the official brand kit ("Grape" variant): https://openrouter.ai/brand
export function OpenRouterMark({ size = 24 }: { size?: number }) {
  const width = Math.round(size * (1024 / 730));
  return <svg aria-hidden="true" className="openrouter-mark" width={width} height={size} viewBox="0 0 1024 730" fill="none" xmlns="http://www.w3.org/2000/svg">
