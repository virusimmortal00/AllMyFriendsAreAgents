 ...
 */
export function IntegrationsPage({ refreshKey, onOpenAdministration }: { refreshKey?: number; onOpenAdministration: () => void }) {
  return <div className="administration-page integrations-page" aria-label="Integrations">
    ...
    <div className="integrations-body">
      ...
      <OpenRouterCreditsSection refreshKey={refreshKey} onOpenAdministration={onOpenAdministration} />
    </div>
  </div>;
}
