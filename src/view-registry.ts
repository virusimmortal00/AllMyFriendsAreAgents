...
export const VIEWS = {
  ...
  serverAdministration: defineView({ id: "WORK-12", name: "Server Administration", state: "Explorer window with page list; Session page for claim, sign-in, and active administrator session", category: "workspace" }),
