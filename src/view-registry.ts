...
export const VIEWS = {
  ...
  serverAdministration: defineView({ id: "WORK-12", name: "Server Administration", state: "Top-level window over chat with page list; Owner login page, also shown in place on locked pages", category: "workspace" }),
