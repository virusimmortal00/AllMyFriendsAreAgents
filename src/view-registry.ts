...
export const VIEWS = {
  ...
  serverAdministration: defineView({ id: "WORK-12", name: "Server Administration", state: "Top-level window over chat with page list; Session page for claim, sign-in, and active administrator session", category: "workspace" }),
