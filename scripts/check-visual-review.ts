...
import { hashBytes, validateVisualReceipts, validateVisualReview, visualInputDigest } from "./visual-review.js";
...
try {
  ...
  const run = JSON.parse(readFileSync(resolve(runDirectory, "manifest.json"), "utf8"));
